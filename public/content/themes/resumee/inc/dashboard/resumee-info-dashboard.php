...
?>
		...
		<!-- 	<div class="col-md-7">
			...
			<div class="row">
					...
					<span class="dashboard-upgrade-button"><a href="https://asphaltthemes.com/resumee#buy_pro" target="_blank">Upgrade</a></span>
					...
					<ul>
						...
						<li>Check out the <a target="_blank" href="<?php echo esc_url('https://asphaltthemes.com/resumee#demos'); ?>">Resumee Demo Templates</a></li>
					</ul>
			...
			<div class="row flexify--center">
				<div class="col-md-7">
					...
					<p>Build your own clean & professional online resume with Resumee Pro. Upgrade now, comes with 14 refund policy.</p>
				</div>

				<div class="col-md-5 dashboard-cta-right">
					<a class="theme__cta--download--pro" href="<?php echo esc_url('https://asphaltthemes.com/resumee#buy_pro'); ?>">Upgrade Now</a>
		...
		<div class="dashboard__blocks">
			<div class="col-md-4">
				<h3>Get Support</h3>
				<ol>
					<li>Resumee <a target="_blank" href="<?php echo esc_url('https://asphaltthemes.com/docs/upgrading-to-resumee-pro/upgrading-to-resumee-pro/'); ?>">Documentation</a></li>
			...
			<div class="col-md-4">
				...
				<ol>
					<li><a target="_blank" href="<?php echo esc_url('https://asphaltthemes.com/docs/upgrading-to-resumee-pro/how-to-setup-front-page/'); ?>">How To Set up the Front Page</a></li>
					<li><a target="_blank" href="<?php echo esc_url('https://asphaltthemes.com/docs/upgrading-to-resumee-pro/upgrading-to-resumee-pro/'); ?>">Upgrading To Resumee Pro</a></li>
					<li><a target="_blank" href="<?php echo esc_url('https://asphaltthemes.com/docs/resumee/upgrading-to-resumee-pro/basic-site-settings/'); ?>">Basic Site Settings</a></li>
				</ol>
			</div>
		</div>
